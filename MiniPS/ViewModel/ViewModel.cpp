...
void ViewModel::ExecContrastCommand(double contrast_value,double brightness_value)
{   
	model->Contrast(contrast_value,brightness_value);
}
void ViewModel::ExecGaussianFilterCommand()
{
...
void ViewModel::ExecFilter1Command()
{
	model->Filter_1_Past();
}
void ViewModel::ExecFilter2Command()
{
